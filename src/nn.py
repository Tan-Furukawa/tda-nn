...
a2 = layers.Conv2D(16, (3, 3), activation='relu', padding="same")(input2)
...
a2 = layers.MaxPooling2D((2, 2))(a2)
a2 = layers.Conv2D(128, (3, 3), activation='relu', padding="same", kernel_regularizer=regularizers.l2(0.1))(a2)
...
# モデルのトレーニング
history = model.fit([x1_train, x2_train], y_train, epochs=200, batch_size=100, validation_data=([x1_test, x2_test], y_test))
